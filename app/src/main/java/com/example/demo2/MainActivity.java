...
import com.example.demo2.delete.InterfaceDelete;
import com.example.demo2.select.InterfaceSelect;
import com.example.demo2.select.SvrResponseSelect;
import com.example.demo2.update.InterfaceUpdate;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void insertData(EditText txt1, EditText txt2, EditText txt3, TextView tvKQ){
        ...
        Retrofit retrofit=new Retrofit.Builder()
                .baseUrl("http://192.168.0.100/000/2024071/")
